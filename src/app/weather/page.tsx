...
───────────────────────────────────────────── */
const getHourlyForecast = (isAr: boolean): HourlyEntry[] => [
  {
    time: isAr ? "٦ ص" : "6 AM",
    temp: 24,
    icon: "sun",
    tip: isAr ? "أفضل وقت للري" : "Best time to water",
    active: false,
  },
  {
    time: isAr ? "٨ ص" : "8 AM",
    temp: 27,
    icon: "sun",
    tip: isAr ? "رعاية الصباح الاعتيادية" : "Morning routine care",
    active: false,
  },
  {
    time: isAr ? "١٠ ص" : "10 AM",
    temp: 30,
    icon: "sun",
    tip: isAr ? "افحص رطوبة التربة" : "Check soil moisture",
    active: false,
  },
  {
    time: isAr ? "١٢ م" : "12 PM",
    temp: 34,
    icon: "sun",
    tip: isAr ? "أدخل نباتات الظل للداخل" : "Move shade plants indoors",
    active: true,
  },
  {
    time: isAr ? "٢ م" : "2 PM",
    temp: 38,
    icon: "sun",
    tip: isAr ? "ذروة الحر – تجنب الري" : "Peak heat – avoid watering",
    active: false,
  },
  {
    time: isAr ? "٤ م" : "4 PM",
    temp: 36,
    icon: "cloud",
    tip: isAr ? "غيوم جزئية" : "Slight cloud cover",
    active: false,
  },
  {
    time: isAr ? "٦ م" : "6 PM",
    temp: 31,
    icon: "cloud",
    tip: isAr ? "نافذة الري الثانية" : "Second watering window",
    active: false,
  },
  {
    time: isAr ? "٨ م" : "8 PM",
    temp: 26,
    icon: "cloud",
    tip: isAr ? "يمكن إضافة السماد عند الحاجة" : "Fertilize if needed",
    active: false,
  },
];

const getWeeklyForecast = (isAr: boolean): DayEntry[] => [
  {
    day: isAr ? "اليوم" : "Today",
    icon: "sun",
    high: 38,
    low: 22,
    tip: isAr ? "اسقِ بعمق في الصباح" : "Water deeply in the morning",
  },
  {
    day: isAr ? "الثلاثاء" : "Tue",
    icon: "sun",
    high: 40,
    low: 24,
    tip: isAr
      ? "اسقِ مسبقاً – ذروة الحر غداً"
      : "Pre-water today — peak heat tomorrow",
  },
  {
    day: isAr ? "الأربعاء" : "Wed",
    icon: "cloud",
    high: 35,
    low: 21,
    tip: isAr
      ? "غائم – يوم ممتاز لزراعة الشتلات"
      : "Cloudy — great day to transplant",
  },
  {
    day: isAr ? "الخميس" : "Thu",
    icon: "cloud",
    high: 33,
    low: 20,
    tip: isAr ? "تعرض شمس أقل للشتلات" : "Reduced sun exposure for seedlings",
  },
  {
    day: isAr ? "الجمعة" : "Fri",
    icon: "rain",
    high: 28,
    low: 18,
    tip: isAr ? "أمطار متوقعة – أوقف الري" : "Rain expected — skip irrigation",
  },
  {
    day: isAr ? "السبت" : "Sat",
    icon: "rain",
    high: 26,
    low: 17,
    tip: isAr ? "افحص الصرف بعد الأمطار" : "Check drainage after rainfall",
  },
  {
    day: isAr ? "الأحد" : "Sun",
    icon: "sun",
    ...
    low: 19,
    tip: isAr
      ? "بعد الأمطار: راقب علامات الفطريات"
      : "Post-rain: inspect for fungal signs",
  },
];
...
const plantSafetyData: PlantSafety[] = [
  {
    emoji: "🌵",
    name: "Succulents",
    nameAr: "النباتات العصارية",
    status: "safe",
    note: "Thriving in heat",
    noteAr: "تزدهر في الحرارة",
  },
  {
    emoji: "🥦",
    name: "Vegetables",
    nameAr: "الخضروات",
    status: "caution",
    note: "Water twice daily",
    noteAr: "اسقِ مرتين يومياً",
  },
  {
    emoji: "🌴",
    name: "Tropical Plants",
    nameAr: "النباتات الاستوائية",
    status: "danger",
    note: "Move to shade now",
    noteAr: "انقلها للظل الآن",
  },
  {
    emoji: "🌿",
    name: "Herbs",
    nameAr: "الأعشاب",
    status: "safe",
    note: "Morning watering only",
    noteAr: "ري صباحي فقط",
  },
  {
    emoji: "🌸",
    name: "Flowering Plants",
    nameAr: "النباتات المزهرة",
    status: "caution",
    note: "Shield from noon sun",
    noteAr: "احمِها من شمس الظهيرة",
  },
  {
    emoji: "🌱",
    name: "Seedlings",
    nameAr: "الشتلات",
    status: "danger",
    note: "Bring indoors immediately",
    noteAr: "أدخلها الداخل فوراً",
  },
];

const getAiRecommendations = (isAr: boolean) => [
  {
    color: "border-blue-400",
    text: isAr
      ? "🌊 زد تكرار الري اليوم – النباتات تفقد رطوبة أكثر في حرارة 34 درجة."
      : "🌊 Increase watering frequency today — plants lose more moisture in 34°C heat.",
  },
  {
    color: "border-green-400",
    text: isAr
      ? "🌿 أبعد النباتات المحبة للظل (سرخس، بوثوس) عن الشمس المباشرة بين 11 ص–3 م."
      : "🌿 Move shade-loving plants (ferns, pothos) away from direct sun between 11 am–3 pm.",
  },
  {
    color: "border-cyan-400",
    text: isAr
      ? "💧 رشّ النباتات الداخلية مرتين اليوم لمواجهة رطوبة 45% المنخفضة."
      : "💧 Mist indoor plants twice today to combat the low 45% humidity.",
  },
  {
    color: "border-yellow-400",
    text: isAr
      ? "🌱 أجّل التسميد – الإجهاد الحراري يمنع النبات من امتصاص العناصر الغذائية."
      : "🌱 Hold off on fertilizing — heat stress makes plants unable to absorb nutrients properly.",
  },
  {
    color: "border-amber-400",
    text: isAr
      ? "☀️ ضع مهاداً عاكساً لحماية التربة من الجفاف السريع."
      : "☀️ Apply sunscreen mulch to protect soil from drying out rapidly.",
  },
  {
    color: "border-emerald-400",
    text: isAr
      ? "⏰ اسقِ في الصباح الباكر (6–8 ص) أو المساء (6–8 م) لتقليل التبخر."
      : "⏰ Water in the early morning (6–8 am) or evening (6–8 pm) to minimize evaporation.",
  },
];
...
function AlertBadge({ level, isAr }: { level: AlertLevel; isAr: boolean }) {
  const cfg = {
    safe: {
      ...
      label: isAr
        ? "✅ آمن – طقس مثالي للنباتات"
        : "✅ All Clear — Ideal plant weather",
    },
    caution: {
      bg: "bg-amber-500/15",
      ...
      label: isAr
        ? "⚠️ تنبيه – راقب النباتات الحساسة"
        : "⚠️ Caution — Monitor sensitive plants",
    },
    danger: {
      bg: "bg-red-500/15",
      ...
      icon: <AlertTriangle className="w-4 h-4" />,
      label: isAr
        ? "🔥 تحذير حرارة – احمِ النباتات"
        : "🔥 Heat Alert — Protect sensitive plants",
    },
  }[level];
  ...
  return (
    <div className="relative inline-flex items-center gap-2.5">
      {level === "danger" && (
        <span
          className={`absolute inset-0 rounded-full ${cfg.bg} pulse-ring`}
        />
      )}
      <span
        className={`relative flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-semibold ${cfg.bg} ${cfg.border} ${cfg.text}`}>
        {cfg.icon}
        {cfg.label}
      </span>
    </div>
...
function StatusPill({ status, isAr }: { status: AlertLevel; isAr: boolean }) {
  const map = {
    safe: {
    ...
    caution: {
      ...
      text: "text-amber-400",
      label: isAr ? "تنبيه ⚠️" : "Caution ⚠️",
    },
    danger: {
      bg: "bg-red-500/10",
      border: "border-red-500/30",
      text: "text-red-400",
      label: isAr ? "خطر ❌" : "Danger ❌",
    },
  }[status];
  return (
    <span
      className={`text-xs font-bold px-2.5 py-0.5 rounded-full border ${map.bg} ${map.border} ${map.text}`}>
      {map.label}
    </span>
  );
}
...
export default function WeatherPage() {
  ...
  const hourlyForecast = getHourlyForecast(isAr);
  const weeklyForecast = getWeeklyForecast(isAr);
  const aiRecommendations = getAiRecommendations(isAr);

  /* clock tick */
  useEffect(() => {
    const update = () =>
      setCurrentTime(
        new Date().toLocaleTimeString(isAr ? "ar-EG" : "en-EG", {
          hour: "2-digit",
          minute: "2-digit",
          hour12: true,
        }),
  ...
  return (
    <div
      ...
      <div
        className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-24 relative z-10"
        key={refreshKey}>
        {/* ══ HERO ══ */}
        <motion.div
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-amber-500/25 bg-amber-500/10 text-amber-400 text-sm font-semibold mb-6">
            🌤️ {isAr ? "ذكاء اصطناعي لتحليل الطقس" : "AI Weather Intelligence"}
          </div>

          <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-4">
            {isAr ? "الطقس و" : "Weather & "}{" "}
            <span className="shimmer-text">
              {isAr ? "رعاية النباتات" : "Plant Insights"}
            </span>
          </h1>

          <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto mb-6 leading-relaxed">
            {isAr
              ? "تحليل الطقس في الوقت الفعلي مع توصيات رعاية النباتات المدعومة بالذكاء الاصطناعي بناءً على ظروف اليوم."
              : "Real-time weather analysis with AI-powered plant care recommendations tailored to today's conditions."}
          </p>
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <div className="flex items-end gap-1">
                  ...
                  <span className="text-4xl font-bold text-amber-400 mb-3">
                    °C
                  </span>
                </div>
                <p className="text-slate-300 text-xl font-semibold mt-1">
                  {isAr ? "مشمس في معظمه" : "Mostly Sunny"}
                </p>
                <p className="text-slate-500 text-sm">
                  {isAr ? "محافظة القاهرة" : "Cairo Governorate"}
                </p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  label: isAr ? "الإحساس بالحرارة" : "Feels Like",
                  val: "38°C",
                },
                {
                ...
                },
                {
                  ...
                  val: isAr ? "١٢ كم/س" : "12 km/h",
                },
                {
                  icon: <Sun className="w-4 h-4 text-yellow-400" />,
                  label: isAr ? "مؤشر الأشعة فوق البنفسجية" : "UV Index",
                  val: isAr ? "٨ · مرتفع" : "8 · High",
                },
              ].map((m, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 px-3.5 py-2.5 bg-slate-950/50 border border-slate-800/60 rounded-2xl min-w-[130px]">
                  {m.icon}
                  <div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <p className="text-xs text-slate-500 uppercase tracking-widest font-semibold mb-2">
                {isAr ? "حالة سلامة النباتات" : "Plant Safety Status"}
              </p>
              <AlertBadge level={alertLevel} isAr={isAr} />
            </div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-extrabold text-white">
                🤖{" "}
                {isAr
                  ? "توصيات الذكاء الاصطناعي لرعاية النباتات اليوم"
                  : "AI Plant Care Recommendations for Today"}
              </h2>
              <p className="text-slate-400 text-xs mt-0.5">
                {isAr
                  ? "بناءً على ظروف القاهرة الحالية · ٣٤° · مشمس · أشعة UV 8"
                  : "Based on current Cairo conditions · 34°C · Sunny · UV 8"}
              </p>
            </div>
          </div>
        ...
        <motion.div
          ...
          <motion.div
            variants={fadeUp}
            className="p-5 bg-slate-900/30 backdrop-blur-md rounded-3xl border border-slate-800/60">
            ...
            <p className="text-[11px] text-amber-400 font-medium">
              {isAr
                ? "🌱 حرارة مرتفعة – اسقِ بعمق"
                : "🌱 High heat — water deeply"}
            </p>
          </motion.div>
          ...
          <motion.div
            variants={fadeUp}
            className="p-5 bg-slate-900/30 backdrop-blur-md rounded-3xl border border-slate-800/60 flex flex-col items-center">
            ...
            <p className="text-[11px] text-slate-400 mt-3 text-center">
              {isAr ? "المدى المثالي: " : "Optimal range: "}
              <span className="text-slate-200">50–70%</span>
            </p>
            <p className="text-[11px] text-blue-400 font-medium mt-1">
              {isAr
                ? "💧 أقل من المثالي – رشّ النباتات"
                : "💧 Below optimal — mist plants"}
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            <div className="space-y-1.5 mb-4">
              {[{ w: "w-full" }, { w: "w-3/4" }, { w: "w-1/2" }].map((l, i) => (
                <div
                  key={i}
                  className={`h-0.5 rounded-full bg-cyan-500/40 wind-anim ${l.w}`}
          ...
          <motion.div
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-semibold text-slate-300">
                {isAr ? "مؤشر الأشعة فوق البنفسجية" : "UV Index"}
              </span>
            </div>
            <div className="flex items-end gap-2 mb-1">
              ...
              <span className="text-red-400 text-sm font-bold mb-1">
                {isAr ? "مرتفع" : "High"}
              </span>
            </div>
            <div className="flex justify-between text-[9px] text-slate-600 mb-0.5">
              ...
              <span>{isAr ? "شديد" : "Extreme"}</span>
            </div>
            <UVBar value={8} />
            <p className="text-[11px] text-yellow-400 font-medium mt-3">
              {isAr
                ? "🌂 احمِ النباتات الحساسة للشمس"
                : "🌂 Shield sun-sensitive plants"}
            </p>
          </motion.div>
        </motion.div>
        ...
        <motion.div
          ...
          <h2 className="text-2xl font-extrabold text-white mb-4 flex items-center gap-2">
            ...
            {isAr ? "التوقعات بالساعة" : "Hourly Forecast"}
          </h2>
            ...
            <motion.div
              ...
              {hourlyForecast.map((h, i) => (
                <motion.div
                  ...
                  <span
                    className={`text-xs font-semibold ${h.active ? "text-emerald-400" : "text-slate-400"}`}>
                    {h.time}
                  </span>
                  <WeatherIcon type={h.icon} className="w-7 h-7" />
                  <span
                    className={`text-xl font-extrabold ${h.active ? "text-white" : "text-slate-200"}`}>
                    {h.temp}°
                  </span>
                  <span className="text-[10px] text-slate-500 text-center leading-tight max-w-[90px]">
                    {h.tip}
                  </span>
                  {h.active && (
        ...
        <motion.div
          ...
          <h2 className="text-2xl font-extrabold text-white mb-4 flex items-center gap-2">
            <Leaf className="w-6 h-6 text-emerald-400" />
            {isAr ? "توقعات النباتات لـ ٧ أيام" : "7-Day Plant Forecast"}
          </h2>
            ...
            <motion.div
              ...
              {weeklyForecast.map((d, i) => (
                <motion.div
                  ...
                  <span
                    className={`text-xs font-bold uppercase tracking-wide ${i === 0 ? "text-emerald-400" : "text-slate-400"}`}>
                    {d.day}
                  </span>
        ...
        <motion.div
          ...
          <h2 className="text-2xl font-extrabold text-white mb-2 flex items-center gap-2">
            ...
            {isAr ? "لوحة سلامة النباتات" : "Plant Safety Dashboard"}
          </h2>
          <p className="text-slate-400 text-sm mb-5">
            {isAr
              ? "تقييم المخاطر الحالي لكل نوع نبات بناءً على طقس اليوم."
            ...
            {plantSafetyData.map((p, i) => {
              ...
              return (
                <motion.div
                  ...
                  <div
                    className={`absolute inset-0 rounded-2xl transition-colors pointer-events-none ${glowColor}`}
                  />
          ...
          {[
            {
              ...
              label: isAr ? "مدى الرؤية" : "Visibility",
              val: isAr ? "١٠ كم" : "10 km",
              sub: isAr ? "سماء صافية" : "Clear skies",
            },
            {
              icon: <Cloud className="w-5 h-5 text-slate-400" />,
              label: isAr ? "الغطاء السحابي" : "Cloud Cover",
              val: isAr ? "٥٪" : "5%",
              sub: isAr ? "صافٍ في معظمه" : "Mostly clear",
            },
            {
              icon: <Zap className="w-5 h-5 text-yellow-400" />,
              label: isAr ? "جودة الهواء" : "Air Quality",
              val: isAr ? "جيد" : "Good",
              sub: isAr ? "مؤشر ٤٢" : "AQI 42",
            },
            {
              icon: <Droplets className="w-5 h-5 text-blue-400" />,
              label: isAr ? "نقطة الندى" : "Dew Point",
              val: "18°C",
              sub: isAr ? "مريح" : "Comfortable",
            },
          ].map((s, i) => (
            <div
              key={i}
              className="p-4 bg-slate-900/30 backdrop-blur-md rounded-2xl border border-slate-800/60 text-center hover:border-slate-700/70 transition-all">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-slate-600 text-xs text-center">
              ...
              {isAr
                ? "سنبلة · ذكاء النبات بالذكاء الاصطناعي"
                : "Sonbula · AI Plant Intelligence"}
            </p>
          </div>

          <p className="text-center text-slate-700 text-xs mt-6">
            {isAr
              ? "بيانات الطقس تجريبية لأغراض العرض فقط."
